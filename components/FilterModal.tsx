...
const ModalFilterItem = styled.View<{ ModalFilterType?: string }>`
  flex-direction: ${props => props.ModalFilterType ? props.ModalFilterType : 'row'};
  align-items:${props => props.ModalFilterType === 'column' ? 'baseline' : 'center'};
  margin-top:15px;
    ...
    >
      ...
      >
        ...
        >
          ...
          <ModalFilterItem 
            ModalFilterType={'column'}
          >
            <ModalFilterItemText ModalTextType={'column'}>태그</ModalFilterItemText>
            <ModalFilterTagList>
